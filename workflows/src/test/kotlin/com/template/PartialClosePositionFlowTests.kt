...
import perp_flows.PartialClosePositionFlow
import kotlin.test.assertEquals


class PartialClosePositionFlowTests {
    ...
    fun partialClosePositionTest() {
        ...
        //Close position
        val partialClosePositionFlow = PartialClosePositionFlow.Initiator("BTC", 0.001, exchange.info.legalIdentities[0], oracle.info.legalIdentities[0])
        val future1 = trader1.startFlow(partialClosePositionFlow)
